...
expenses = Table(
    ...
    metadata,
    Column("id", Integer, primary_key=True),
    Column("date", DATE, doc='Дата фактического платежа'),
    Column("date_accrual", DATE, doc='Дата начисления'),
    ...
    Column("status_pay", Boolean, default=True, doc='Признак фактического платежа')
)
