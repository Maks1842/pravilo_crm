...
legal_work = Table(
    ...
    Column("summa_claim", Numeric(12, 2), doc='Сумма по Иску'),
    Column("date_incoming_ed", DATE, doc='Дата поступления ИД'),
    Column("date_stop_case", DATE, doc='Дата приостановки рассмотрения дела'),
    Column("summa_state_duty_claim", Numeric(12, 2), doc='Сумма ГП по Иску'),
    Column("summa_state_duty_result", Numeric(12, 2), doc='Сумма ГП по Решению'),
    ...
    Column("summa_result_2", Numeric(12, 2), doc='Сумма по Решению 2 (Поворот)'),
    ...
    Column("summa_ed", Numeric(12, 2), doc='Сумма по ИД (по решению)'),
