...
# Получить/добавить 395(СП)
router_tribun395_write = APIRouter(
    prefix="/v1/Tribun395Writ",
    tags=["LegalWork"]
)
...
@router_tribun395_write.post("/")
async def add_tribun395_write(data: dict, session: AsyncSession = Depends(get_async_session)):
