...
class RePattern:
    ...
    # Расходы из "Назначение платежа"
    state_duty = r'(?i)Государственная\s+пошлина'
    lukoil_pay = r'(?i)Расчеты\s+через.+LUKOIL.+карте.+7427'
    card_pay = r'(?i)Расчеты\s+через.+карте.+7427'
